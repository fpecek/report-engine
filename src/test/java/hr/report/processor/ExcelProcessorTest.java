...
/**
 * Testing excel exporter processor working as expected.
 *
 * @author frano.pecek
 */
...
public class ExcelProcessorTest {
    ...
    @Autowired
    private ExportProcessor excelExportProcessor;

    /**
     * Test excel exporter processor is successfully created excel file.
     *
     * @throws JRException jasper exception
     * @throws IOException exception creating file
     */
    @Test
    public void testExcel() throws JRException, IOException {
        ...
        final ByteArrayOutputStream reportStream = excelExportProcessor.exportReport(dataSource, report);

        final File reportFile = File.createTempFile("report_", ".xls");
    ...
    public void testGetType() {
        assertEquals(ReportFileType.EXCEL, excelExportProcessor.getType());
    }
