...
/**
 * Testing HTML exporter processor working as expected.
 *
 * @author frano.pecek
 */
...
public class HtmlProcessorTest {
    ...
    @Autowired
    private ExportProcessor htmlExportProcessor;

    /**
     * Test HTML exporter processor is successfully created HTML file.
     *
    ...
    public void testHtml() throws JRException, IOException {
        ...
        final ByteArrayOutputStream reportStream = htmlExportProcessor.exportReport(dataSource, report);

        final File reportFile = File.createTempFile("report_", ".html");
    ...
    public void testGetType() {
        assertEquals(ReportFileType.HTML, htmlExportProcessor.getType());
    }
