...
/**
 * Testing PDF exporter processor working as expected.
 *
 * @author frano.pecek
 */
...
public class PdfProcessorTest {
    ...
    @Autowired
    private ExportProcessor pdfExportProcessor;

    /**
     * Test PDF exporter processor is successfully created PDF file.
     *
    ...
    public void testPdf() throws JRException, IOException {
        ...
        final ByteArrayOutputStream reportStream = pdfExportProcessor.exportReport(dataSource, report);

        final File reportFile = File.createTempFile("report_", ".pdf");
    ...
    public void testGetType() {
        assertEquals(ReportFileType.PDF, pdfExportProcessor.getType());
    }
